package com.base.template.fragment;
...
import com.base.template.MyActivity;
...
public class GuideFragment extends Fragment {
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		m_obj_viewPager = (ViewPager) view
				.findViewById(R.id.id_guide_viewpager);
		initView();
	...
	private void initView() {
		m_obj_adapter = new Wz_myViewPagerAdapter(ids, m_obj_Layoutview,
				getActivity());
	}
