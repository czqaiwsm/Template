package com.base.template.viewpagerAdapter;
...
import com.base.template.model.BannerImgInfo;
...
public class Wz_myViewPagerAdapter extends PagerAdapter {
	 ...
	 * @param context
	 */
	public Wz_myViewPagerAdapter(int id[], View view, Context context) {
	...
	public Wz_myViewPagerAdapter(ArrayList<BannerImgInfo> bannerImgInfos, View view, Context context) {
		this.context = context;
...
//	}
	 ...
	 */
	public void setAutoPlay(ViewPager viewPager,boolean isAutoPlay) {
	...
	private boolean initDot() {
		...
		if (m_i_picId.length > 0) {
			ImageView dotView;
			for (int i = 0; i < m_i_picId.length; i++) {
	...
	public void moveCursorTo(int position) {
		position = position % m_i_picId.length;
