...
public class AlertDialogUtils {
     ...
     * @return
     */
    public static Dialog displayMyAlertChoice(Context context, int title, int message, int positiveBtnText, View.OnClickListener positionOnclick, int negativeBtnText,
                                              View.OnClickListener negativeOnclick) {
     ...
     * @return
     */
    public static void displayMyAlertChoice(final Context context, String title, String message, boolean canceal,final View.OnClickListener positionOnclick) {

        final Dialog builder = new Dialog(context, R.style.MyDialog);
        builder.setCancelable(canceal);
        builder.setCanceledOnTouchOutside(canceal);
    ...
    public static Dialog displayMyAlertChoice(Context context, final Dialog builder, int title, int message, int positiveBtnText, View.OnClickListener positionOnclick, int negativeBtnText,
                                              View.OnClickListener negativeOnclick) {
