//package com.hyl.hylbase.pay.wx;
//
//import android.os.Handler;
//import android.util.Log;
//import android.util.Xml;
//import com.hyl.hylbase.HylBaseApplication;
...
// * @data 2016/1/14
// */
//public class WxPayTask extends AsyncTask<News,Void,Map<String,String>> {
//
//    public static String WX_NOTIFYURL = "";
//    private final String TAG = WxPayTask.class.getName();
//
//    private PayReq req;
//    final IWXAPI msgApi = WXAPIFactory.createWXAPI(HylBaseApplication.getInstance(), WxPayConstants.APP_ID.trim());
...
//        req = new PayReq();
//        msgApi.registerApp(WxPayConstants.APP_ID.trim());
//    }
//
//    @Override
...
//    @Override
//    protected Map<String, String> doInBackground(News... params) {
//
//        String url = String.format("https://api.mch.weixin.qq.com/pay/unifiedorder");
//        PayMessage mPayMessage = new PayMessage();
//        mPayMessage.setAppid(WxPayConstants.APP_ID.trim());
//        mPayMessage.setMch_id(WxPayConstants.MCH_ID.trim());
...
//        mPayMessage.setNotify_url(WxPayTask.WX_NOTIFYURL);//支付完成后的回调地址
//        /******body,Out_trade_no,Total_fee都是请求后台的接口得到的，即在“统一下单”前，要去请求后台接口*******/
//
//        mPayMessage.setSpbill_create_ip("127.0.0.1");
//        mPayMessage.setTrade_type("APP");
//        String sign = SignUtil.sign(SignUtil.sortedMapToSortedParams(SignUtil.orderParams(mPayMessage)), WxPayConstants.API_KEY.trim());
...
//            e.printStackTrace();
//        }
//        byte[] buf = com.hylsmart.xdfoode.wxutils.Util.httpPost(url, entity);
...
//        req.appId = WxPayConstants.APP_ID.trim();
//        req.partnerId = WxPayConstants.MCH_ID.trim();
...
//        String sign = SignUtil.sign(SignUtil.sortedMapToSortedParams(params), WxPayConstants.API_KEY.trim());
//        req.sign = sign;
//    }
//
...
//        return com.hylsmart.xdfoode.wxutils.MD5.getMessageDigest(String.valueOf(random.nextInt(10000)).getBytes());
//    }
//
