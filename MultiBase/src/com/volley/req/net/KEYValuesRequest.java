...
public class KEYValuesRequest extends JsonRequest<Object> {
    ...
    public static void main(String arg[]){
        ...
        String json = "{\"data\":{\"history\":\"\",\"region\":\"安徽省池州市东至县\",\"id\":53,\"createTime\":\"2016-05-30 17:43:54\",\"idCard\":\"342423199004203970\",\"cases\":\"http:\\/\\/114.215.187.74:10701\\/hulizhijia-api\\/\\/uploads\\/dynamic\\/2016\\/05\\/301743_GM2nWX.jpg\",\"address\":\"包河小区 112\",\"prescriptions\":\"\",\"name\":\"杨02\",\"userId\":23,\"relation\":\"亲属\",\"instrument\":1,\"medicine\":0,\"type\":3,\"allergy\":\"\"},\"code\":\"200\"}";

//        JsonParserBase<ComplePatientDetailEntity> jsonParser = ParserUtil.fromJsonBase(json, new TypeToken<JsonParserBase<ComplePatientDetailEntity>>() {
//        }.getType());
//        ComplePatientDetailEntity data = jsonParser.getData();
    }
